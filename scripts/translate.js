function translator(input, id){
    ...
    if(id === "letters") {
        ...
        morseArray = wordsArray.map(word => {
            let characters = word.split("");

            let newWord = characters.map(char => {
                return cypher[char] + " "; //add one space between letters
            });
        ...
        console.log(typeof(morseArray));
        morseString = String(morseArray);
